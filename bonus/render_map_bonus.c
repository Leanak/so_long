...
/*   Updated: 2025/07/21 20:06:29 by lenakach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	elem_others(t_window *game, int i, int j, char elem)
{
	if (elem == 'P')
		...
		mlx_put_image_to_window(game->mlx, game->mlx_win,
			game->collect_anim->frames[game->collect_anim->current], j
			* TILE_SIZE, i * TILE_SIZE);
	else if (elem == 'E')
		mlx_put_image_to_window(game->mlx, game->mlx_win, game->img_exit, j
			* TILE_SIZE, i * TILE_SIZE);
	else if (elem == 'X')
		mlx_put_image_to_window(game->mlx, game->mlx_win, game->img_ennemy, j
			* TILE_SIZE, i * TILE_SIZE);
}
